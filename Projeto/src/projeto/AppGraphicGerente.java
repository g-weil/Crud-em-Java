 ...
 */
public class AppGraphicGerente extends javax.swing.JFrame {

    /**
     * Creates new form AppGraphicPagamento
     */
    public AppGraphicGerente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Cadastro do gerente");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            stmt.execute("INSERT INTO gabriel_pessoa(nome,email,cpf,telefone,data_nascimento) VALUES('"+nome+"','"+email+"','"+cpf+"','"+telefone+"','"+data_nascimento+"');");  ///preparaco da insercao do registro
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        try {
            ...
            stmt.execute("UPDATE gabriel_pessoa SET nome = '"+nome+"', email = '"+email+"', cpf = '"+cpf+"', telefone = '"+telefone+"',"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AppGraphicGerente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AppGraphicGerente().setVisible(true);
            }
        });
    }
